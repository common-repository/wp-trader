...
//Add users ip to user meta for ip tracking on announce(comment in wrong place)
if( ! function_exists("wptrader_update") ) {
...
if( ! function_exists("count_torrent_no_seeders") ) {
...
if( ! function_exists("count_torrent_no_leechers") ) {
...
//Probably should change to an actual wordpress function
