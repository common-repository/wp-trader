...
== CHANGELOG ==
= Version: beta .4.9 - 2012-12-19 =
* Fixed errors in announce with functions already being called.
* Wrapped most functions with something to see if it already exists or not so not to have the same problem as announce.
* Commented some of the code so people will know what it does.
* Changed the default most active limit on install from 10 to 5.
* Changed the latest upload name shortner on install from 18 to 10.
* Changed the seed wanted name shortner on install from 18 to 10.
